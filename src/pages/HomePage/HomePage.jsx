  ...
  return (
    <>
      ...
      <Section>
        ...
        <Pargaraph>
          При переході на сторінку /tweets поект забирає з бекенда список юзерів
          та відображає його на сторінці у вигляді карток з інформацією про
          кількість твітів та фоловерівна. У кожної картки є інтерактивна кнопка
          з логікою підписки/відписки. При натисканні на кнопку змінюється стан
          та кількість підписників незалежно у кожного юзера.
        </Pargaraph>
        <Pargaraph>
          Також на сторінці /tweets реалізовані:
          <BasicList>
